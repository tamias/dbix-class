...
is_same_sql_bind (
  ...
  '(SELECT me.title FROM (SELECT me.title, tracks.title FROM cd me LEFT JOIN track tracks ON tracks.cd = me.cdid GROUP BY me.title, tracks.title, position ORDER BY position ASC) me)',
  [],
