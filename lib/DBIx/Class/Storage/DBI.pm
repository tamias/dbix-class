...
__PACKAGE__->mk_group_accessors('simple' => qw/
  _connect_info _dbi_connect_info _dbh _sql_maker _sql_maker_opts
...
my @storage_options = qw/
  ...
  prepare_cached disable_sth_caching unsafe auto_savepoint
/;
...
# needs fixing - $cached needs to go into $attrs or something
